...
- [arya-reminders](https://clawskills.sh/skills/staratheris-arya-reminders) - Recordatorios en lenguaje natural (Bogot).
...
- [envios](https://clawskills.sh/skills/jalfargentina-envios) - Usar cuando el usuario pregunte sobre envos, cmo enviar un pedido, tiempos de entrega, zonas de cobertura.
...
- [airfrance-afkl](https://clawskills.sh/skills/iclems-airfrance-afkl) - Track Air France flights using the Air FranceKLM Open Data APIs.
...
- [boj-mcp](https://clawskills.sh/skills/ajtgjmdjp-boj-mcp) - Access Bank of Japan (BOJ/) statistical data  price indices (CGPI, SPPI), flow of funds, balance of payments.
...
- [bcra-central-deudores](https://clawskills.sh/skills/ferminrp-bcra-central-deudores) - Query the BCRA (Banco Central de la Repblica Argentina) Central de Deudores API to check the credit status.
...
- [change-pdf-permissions](https://clawskills.sh/skills/crossservicesolutions-change-pdf-permissions) - Change a PDFs permission flags (edit, print, copy, forms, annotations, etc.) by uploading it to the Solutions API.
...
- [sonarqube-analyzer](https://clawskills.sh/skills/felipeoff-sonarqube-analyzer) - Analisa projetos no SonarQube self-hosted, obtm issues e sugere solues automatizadas.
