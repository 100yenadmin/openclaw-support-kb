...
source_hash: "843b438af77ac6d9f7630454dda9be480c3494b649f2da7012f7b5211bb5119b"
system: "openclaw"
kb_namespace: "openclaw"
doc_path: "plan/cloud-workers.md"
original_doc_path: "plan/cloud-workers.md"
duplicate_index: 1
---
...
type WorkerProvider = {
  id: string;
  provision(profile: WorkerProfile, opId: string): Promise
WorkerLease
; // → ssh host/port/user/key material
  inspect(lease: { leaseId: string; profile: WorkerProfile }): Promise
LeaseStatus
; // adopt/health/orphan sweep
