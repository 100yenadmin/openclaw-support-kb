...
source_hash: "6d58a8f9dea45d56005e985d11d674ed86b6ac917c0f02ff0fc27bb2ae188ff8"
system: "openclaw"
...
Verify and pair
    ...
    ```
    Send a first DM and approve pairing: `openclaw pairing approve signal
CODE
`.
...
5. Pair your DM sender:
   ...
   - Approve on the server: `openclaw pairing approve signal
PAIRING_CODE
`.
...
- Approve via `openclaw pairing list signal` and `openclaw pairing approve signal
CODE
`.
