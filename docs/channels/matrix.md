...
source_hash: "7b32919ffd72fa372747f2d7b5fcfb0105106e307b3c2f7d4160c9f7afd3b379"
system: "openclaw"
...
The recovery key is sensitive - pipe it via stdin instead of passing it on the command line. Set `MATRIX_RECOVERY_KEY` (or `MATRIX_
ID
_RECOVERY_KEY` for a named account):
