...
source_hash: "629fd340d01c2e61d86cb82b149ada29eba7cf300189a0499e0736d2a384ed29"
system: "openclaw"
...
TOKEN
` endpoint. `apiRoot` must be only the Bot API root, and `openclaw doctor --fix` removes an accidental trailing `/bot
TOKEN
`.
