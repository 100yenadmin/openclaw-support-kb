...
original_doc_path: "channels/buzz.md"
duplicate_index: 1
---
...
shared directory lookup. The canonical `buzz:
ROOM_UUID
` target remains the
...
directory, but automation should use `buzz:
ROOM_UUID
` to avoid ambiguity.
