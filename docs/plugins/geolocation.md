...
source: "https://docs.openclaw.ai/plugins/geolocation"
source_hash: "0aea83b7e4cef809a1b00f51eb182bfa286c88fbe2270be789d5b159acf32a37"
system: "openclaw"
kb_namespace: "openclaw"
doc_path: "plugins/geolocation.md"
original_doc_path: "plugins/geolocation.md"
duplicate_index: 1
---
...
```bash
curl -s "http://127.0.0.1:18789/plugins/geolocation/lookup?ip=8.8.8.8" -H "Authorization: Bearer
GATEWAY_TOKEN
"
```
