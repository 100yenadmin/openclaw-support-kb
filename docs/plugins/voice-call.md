...
source_hash: "a4f654fca50e927c84ac00844696935ced20d0c4b10c2dfdb5785a5f195b4453"
system: "openclaw"
...
Twilio notify-mode outbound calls send their initial `
Say
` TwiML directly
...
does not depend on the HTTP status callback. Twilio's optional `
Stream
` is a separate stream-diagnostic signal and is not required for
