...
source_hash: "ebb0cd3c881c4c9050ac815de8cdb83493c005e08ea87fdca328b80cc4525e2d"
system: "openclaw"
kb_namespace: "openclaw"
doc_path: "plugins/copilot.md"
original_doc_path: "plugins/copilot.md"
duplicate_index: 1
---
...
4. **Env-var fallback**, checked in this order (first non-empty value wins,
   ...
   The synthesized pool profile id is `env:
NAME
`; the profile version is a
