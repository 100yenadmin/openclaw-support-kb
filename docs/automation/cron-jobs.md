...
source_hash: "27a91b3b1a6685978dbff33977468d6c420ac05df77b3af94c7a83630e00d86c"
system: "openclaw"
...
Warning
Adding `mail_reader` creates an explicit fleet. Keep existing bindings and add one channel-wide binding per enabled channel that `main` still owns; there is no cross-channel wildcard.
