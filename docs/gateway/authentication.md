...
source_hash: "52376a1a387e8fa4c7bdc3a1ecdf9bb9f97ab3ec9c6d1f2ca4f93fb03e4943fa"
system: "openclaw"
...
1. `OPENCLAW_LIVE_
PROVIDER
_KEY` (single override, pins one key)
2. `
PROVIDER
_API_KEYS` (comma/space/semicolon-separated list)
3. `
PROVIDER
_API_KEY`
4. `
PROVIDER
_API_KEY_*` (any env var with this prefix)
