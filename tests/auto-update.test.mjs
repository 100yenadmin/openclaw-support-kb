  ...
  try {
    ...
    await writeFile(
      ...
      [
        ...
        "if [ \"$1\" = \"search\" ]; then echo 'Customer Support KB Agent Protocol openclaw-support-kb Telegram Setup And Repair telegram Hermes Agent config.yaml Paperclip heartbeat budget agent'; exit 0; fi",
        "exit 0",
        "",
      ].join("\n"),
      { mode: 0o755 },
  ...
  try {
    ...
    await writeFile(
      ...
      [
        ...
        "  echo 'Customer Support KB Agent Protocol openclaw-support-kb Telegram Setup And Repair telegram Hermes Agent config.yaml Paperclip heartbeat budget agent'",
        "  exit 0",
        "fi",
        "exit 0",
        "",
